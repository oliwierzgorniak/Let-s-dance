...
function drawSnowflake(sketch, x, y) {
  ...
  const points = [
    { x0: 0, y0: SNOWFLAKE_ARM, x1: 0, y1: -SNOWFLAKE_ARM },
    { x0: SNOWFLAKE_ARM, y0: 0, x1: -SNOWFLAKE_ARM, y1: 0 },
    {
      x0: SNOWFLAKE_ARM / sqrt(2),
      y0: SNOWFLAKE_ARM / sqrt(2),
      x1: -SNOWFLAKE_ARM / sqrt(2),
      y1: -SNOWFLAKE_ARM / sqrt(2),
    },
    {
      x0: SNOWFLAKE_ARM / sqrt(2),
      y0: -SNOWFLAKE_ARM / sqrt(2),
