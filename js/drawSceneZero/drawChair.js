...
function drawChair() {
  ...
  const LEG_POSITIONS_MULTIPLIERS = [{x: 1, y: 1}, {x: -1, y: 1}, {x: 1, y: -1}, {x: -1, y: -1}]
  LEG_POSITIONS_MULTIPLIERS.forEach(({x, y}) => {
  push()
  translate(CHAIR_SITTING_SIZE / 2 * 0.8 * x, CHAIR_SITTING_SIZE / 2 * 0.8 * y, CHAIR_LEG_HEIGHT / 2)
  ...
  push()
  translate(CHAIR_SITTING_SIZE / 2 * 0.8, -CHAIR_SITTING_SIZE / 2 * 0.8, CHAIR_LEG_HEIGHT + CHAIR_SIT_THICKNESS+ CHAIR_BACK_LEG_HEIGHT / 2)
  ...
  push()
  translate(0, -CHAIR_SITTING_SIZE / 2 * 0.8, CHAIR_LEG_HEIGHT + CHAIR_SIT_THICKNESS  + CHAIR_BACK_LEG_HEIGHT + CHAIR_SITTING_SIZE * CHAIR_BACK_HEIGHT_SCALE / 2 )
