...
let cameraProps = {x: 0, y: 500, z: 600, xCentral: 0, yCentral: 0, zCentral: TABLE_HEIGHT + BOTTOM_BOX_HEIGHT}
...
function handleCamera() {
  ...
  switch (cameraMovmentPhase) {
    case 0:
      if (cameraProps.z > TABLE_HEIGHT + BOTTOM_BOX_HEIGHT + 1 && cameraProps.y > 200) {
        cameraProps.y -= 0.34;
        cameraProps.z -= 0.12;
