function drawBoxPanels() {
  const frontPanelWidth = (BOX_WIDTH - LOCK_ONE_RADIUS * 2) / 2 - PANEL_MARGIN * 2
  ...
  push()
  translate(frontPanelWidth / 2 + LOCK_ONE_RADIUS + PANEL_MARGIN, BOX_DEPTH / 2 + PANEL_DEPTH / 2, BOTTOM_BOX_HEIGHT / 2)
