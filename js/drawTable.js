...
const TABLE_HEIGHT = TABLE_CYLIDNER_HEIHGT + TABLE_TOP_CONE_HEIGHT + TABLE_LEG_HEIGHT + TABLE_BOTTOM_CONE_HEIGHT;
...
function drawTable() {
  ...
  push()
  rotateX(90)
  translate(0, -(TABLE_CYLIDNER_HEIHGT + TABLE_TOP_CONE_HEIGHT / 2 + TABLE_LEG_HEIGHT / 2 - TABLE_CYLIDNER_HEIHGT * 0.2), 0)
